...
require (
	...
	github.com/siherrmann/queuer v1.66.0
	github.com/siherrmann/validator v0.20.0
...
require (
	...
	github.com/siherrmann/queuerSql v0.0.0-20251222153022-f7b8a6955910 // indirect
